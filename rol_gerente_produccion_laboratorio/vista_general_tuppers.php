...
<div class="contenedor-pagina d-flex flex-column min-vh-100">
  ...
  <div>
    ...
    <p>Revisión general de todos los lotes en cada etapa del laboratorio.</p>
  </div>
</div>
...
<nav class="filter-toolbar d-flex flex-wrap align-items-center gap-2 px-3 py-2 mb-3" style="overflow-x:auto;">
  ...
  <div class="d-flex flex-column" style="min-width:140px;">
    ...
    <input id="filtro-fecha" type="date" name="fecha" form="filtrosForm" class="form-control form-control-sm"
...
function limpiarFiltros() {
  window.location.href = 'vista_general_tuppers.php';
}
</script>
